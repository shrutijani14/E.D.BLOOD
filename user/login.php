...
<body>
                ...
                <div class="mbr-table">
                    ...
                    <div class="mbr-table-cell">
                        ...
                        <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm"
                            ...
                            <li class="nav-item"><a class="nav-link link" href="../admin/index.php">ADMIN LOGIN</a></li>
                            <li class="nav-item"><a class="nav-link link" href="../doctor/index.php">DOCTOR LOGIN</a></li>
    ...
    <section class="engine"><a rel="external" href="#">easy responsive website maker software download</a></section>
    <section class="mbr-section mbr-after-navbar" id="msg-box3-w"
                ...
                <div class="col-md-8 col-md-offset-2 text-xs-center">
                    ...
                    <form method="post" role="form" class="form-horizontal">
                        <table cellpadding="0" cellspacing="0" width="100%" class="tableborder" style="margin:auto">
                            <tr>
                                <td class="text-xl-right">E-Mail</td>
                            ...
                            <tr>
                                <td class="text-xl-right">Password</td>
                                <td>: <input class="text-input" type="password" name="password" required="required"
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td><input type="submit" value="Sign In " name="btn-login" style="border:0px; border-radius: 10px;  width:150px; height:40px;  box-shadow:1px 1px 5px black; color:white;
