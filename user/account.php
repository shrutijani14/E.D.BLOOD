...
<body>
                        ...
                        <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm"
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link link dropdown-toggle" href="#" data-toggle="dropdown-submenu"
                                    ...
                                    aria-expanded="false"><?php echo $account['lname'];?></a>
    ...
    <section class="mbr-section mbr-section-hero mbr-section-full mbr-after-navbar" id="header2-7"
                    ...
                    <div class="mbr-section row">
                        <div class="mbr-table-md-up">
								...
								?><img class="img-responsive img-thumbnail" src="../assets/images/<?php echo $account['ppic']; ?>" />
                                                ...
                                                <div class="mbr-section-btn">
                                                    <a class="btn btn-primary btn-loading"
                                                        ...
                                                        href="uploadpicture">Edit Profile Picture</a>
                                                </div>
                            ...
                            <div class="mbr-table-cell mbr-valign-top col-md-6">
                                ...
                                <h3 class="mbr-section-title display-2"><span
                                        style="font-weight: normal;text-transform: uppercase; color:#000; text-align: left;">
                                        <?php echo $account['fname'];?>&nbsp; <?php echo $account['lname'];?></span>
                                </h3>

                                <div class="mbr-section-btn">
                                    <a class="btn btn-primary" href="#features7-0"
                                        style="width:200px; padding-left:-10px;"> View Profile</a>
                                    <a class="btn btn-primary" href="updateprofile.php"
                                        style="width:200px; padding-left:-10px;">Update Info</a> </div>
                                <div class="mbr-section-btn">
                                    <a class="btn btn-primary" href="bloodrequest"
                                        style="width:200px; padding-left:-10px;">Send Request</a>
                                    <a class="btn btn-primary" href="viewrequests"
                                        style="width:200px; padding-left:-10px;">View Requests</a>
                                </div>
                                <div class="mbr-section-btn">
                                    <a class="btn btn-primary" href="bloodavailable"
                                        style="width:200px; padding-left:-10px;">Blood Units</a>
                                </div>
                            </div>
        ...
        <div class="mbr-arrow mbr-arrow-floating hidden-sm-down" aria-hidden="true"><a href="#features7-0"><i
                    class="mbr-arrow-icon"></i></a></div>

    </section>

    <section class="mbr-cards mbr-section mbr-section-nopadding" id="features7-0"
        ...
        <div class="mbr-cards-row row">
            <div class="mbr-cards-col col-xs-12 col-lg-4" style="padding-top: 20px; padding-bottom: 20px;">
                <div class="container">
                    <div class="card cart-block">
                        <div class="card-img iconbox"><a href="#"
                                class="etl-icon icon-lightbulb mbr-iconfont mbr-iconfont-features7"
                                style="color: rgb(255, 255, 255);"></a></div>
                        <div class="card-block">
                            <h4 class="card-title">Personal Info</h4>


                            <p class="card-text"><strong>Name:</strong> <?php echo $account['fname'];?> &nbsp;
                                <?php echo $account['lname'];?> <br><br>
                                ...
                                <strong>Age:</strong>
                                <?php $year=date('Y'); $age= $year- $account['year'];  echo $age; ?> Years</p>
            ...
            <div class="mbr-cards-col col-xs-12 col-lg-4" style="padding-top: 20px; padding-bottom: 20px;">
                <div class="container">
                    <div class="card cart-block">
                        <div class="card-img iconbox"><a href="#"
                                class="etl-icon icon-clock mbr-iconfont mbr-iconfont-features7"
                                style="color: rgb(255, 255, 255);"></a></div>
                        <div class="card-block">
                            ...
                            <p class="card-text">
                                ...
                                <strong>Number of
                                    Donations:</strong><?php echo $account['number_of_donations'];?><br><br>
            ...
            <div class="mbr-cards-col col-xs-12 col-lg-4" style="padding-top: 20px; padding-bottom: 20px;">
                <div class="container">
                    <div class="card cart-block">
                        <div class="card-img iconbox"><a href="#"
                                class="etl-icon icon-shield mbr-iconfont mbr-iconfont-features7"
                                style="color: rgb(255, 255, 255);"></a></div>
                        <div class="card-block">
                            <h4 class="card-title">Current Requests</h4>

                            <p class="card-text"><strong>Existing Request:</strong> Bloood Group
                                B+<br><br><strong>Respond to Request:</strong> Otieno
                                Sam/N/A<br><br><strong>Confirmation By Doctor:</strong> Pending<br><br><strong>Date
                                    Responded:</strong> 22/3/2014<br><br><strong>Date Confirmed:</strong> 22/12/2013</p>
