...
<body>
    ...
    <section class="mbr-section mbr-after-navbar" id="msg-box3-v"
        style="background-color: #dddddd; padding-top: 85px; padding-bottom: 10px;">
                    ...
                    ?>
                        ...
                        <form method="post">
                            <table cellpadding="0" cellspacing="0" width="100%" class="tableborder" style="margin:auto">
                                ...
                                <tr>
                                    <td><input class="text-input" type="hidden" name="fname" required="required"
                                            readonly value="<?php echo $account['fname']; ?>" /></td>
                                </tr>
                                <tr>
                                    <td><input class="text-input" type="hidden" name="lname"
                                            value="<?php echo $account['lname']; ?>" readonly /></td>
                                </tr>
                                <tr>
                                    <td><input class="text-input" type="hidden" name="email"
                                            value="<?php echo $account['email']; ?>" readonly /></td>
                                </tr>
                                <tr>
                                    <td><input class="text-input" type="hidden" name="mobile" required="required"
                                            value="<?php echo $account['mobile']; ?>" readonly /></td>
                                </tr>
                                <tr>
                                    <td class="lefttd">Blood Group</td>
                                </tr>
                                <tr>
                                    <td><input class="text-input" type="text" name="b_id"
                                            style="background-color: darkgray; color: red;"
                                            value="<?php echo $account['b_id']; ?>" readonly /></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td class="lefttd">Till Required Date</td>
                                </tr>
                                <tr>
                                    <td>
                                        <input class="text-input" name="reqdate"
                                            style="background-color: darkgray; color: red;"
                                            value="<?php echo date('Y/m/d H:i:s', strtotime('+7 days')); ?>" readonly />
                                    </td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td><input class="text-input" style="color: red;" type="text" name="code"
                                ...
                                <tr>
                                    <td><input class="text-input" type="hidden" name="status" required="required"
                                            value="Waiting" readonly /></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td><input type="submit" value="Send Request" name="btn-request" style="border:0px; border-radius: 10px;  width:150px; height:40px; margin-left: -230px;  box-shadow:1px 1px 5px black; color:white;
