...
if(isset($_POST['btn-contactus']))
{
  ...
  $subject = $MySQLi_CON->real_escape_string(trim($_POST['subject']));
	$message = $MySQLi_CON->real_escape_string(trim($_POST['message']));
  $query = $MySQLi_CON->real_escape_string(trim($_POST['query']));

  $query = "INSERT INTO contactus(name,email,subject,message,query)
        VALUES('$name','$email','$subject','$message','$query')";
                    ...
                    <form method="post" data-form-title="CONTACT FORM">
                      <?php
                        ...
                        <div class="row row-sm-offset">
                         ...
                         <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="form1-0-email">Subject<span class="form-asterisk">*</span></label>
                                    <input type="text" class="form-control" name="subject" required="" data-form-field="Subject" id="form1-0-message">
                                </div>
                        </div>
                        </div>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="form-control-label" for="form1-0-message">Query</label>
                            <textarea class="form-control" name="message" rows="7" data-form-field="Message" id="form1-0-message"></textarea>
                        </div>
...
?> | <a class="text-white" href="about.php">BLOODALTRUIST</a></p>
    </div>
    </div>
</footer>
