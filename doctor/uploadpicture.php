...
<li class="nav-item dropdown"><a class="nav-link link dropdown-toggle" href="http://bloodbank.appslab.co.ke/"  data-toggle="dropdown-submenu" aria-expanded="false">HELP</a><div class="dropdown-menu"><a class="dropdown-item" href="../contact.php">CONTACT US</a><a class="dropdown-item" href="../faqs.php">FAQS</a></div></li></ul>
